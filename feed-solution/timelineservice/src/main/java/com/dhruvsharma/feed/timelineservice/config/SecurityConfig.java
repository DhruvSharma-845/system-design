package com.dhruvsharma.feed.timelineservice.config;
...
/**
 * Security configuration for the Timeline Service.
 *
 ...
 *
 * Authorization rules:
 * - GET  /api/v1/timelines  -> requires feed_user role
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Reading timelines requires feed_user role
                .requestMatchers(HttpMethod.GET, "/api/v1/timelines/**").hasRole("feed_user")
